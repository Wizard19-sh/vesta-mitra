...
| `EVD-018` | Real Meta “Hi” messages from Mohit and Krishna reached the signed webhook and opened provider conversation windows, but both were stored unmatched and no outbound message was sent | Inbound readiness evidence | Observability | N — valid real inbound proof only; no completed task or successful routing claim | Mohit provider message `wamid.HBgMOTE5ODMzNjU3NzY0FQIAEhggQUM1NEMwNjAwNkNCQ0FFQzI3QjcxNTJGMjM1MUQ1MUUA` at 2026-09-05 06:30:02 IST; Krishna provider message `wamid.HBgMOTE5ODIwMzEzNTMzFQIAEhgUM0FDRTA0MDZDNkM1QTA0MURBQ0IA` at 2026-09-05 06:30:28 IST |
